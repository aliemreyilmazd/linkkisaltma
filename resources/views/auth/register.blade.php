...
<div class="bg-base-1 d-flex align-items-center flex-fill">
    <div class="container h-100 py-6">
        ...
        <div class="text-center d-block d-lg-none">
            <h2 class="mb-3 d-inline-block">{{ __('Register') }}</h2>
            <div class="m-auto">
                <p class="text-muted font-weight-normal font-size-lg mb-0">{{ __('Join us.') }}</p>
            </div>
        </div>

        <div class="row h-100 justify-content-center align-items-center pt-4 pt-lg-0 mt-3 mt-lg-0">
            <div class="col-12">
                <div class="card border-0 shadow-sm overflow-hidden">
                    <div class="row no-gutters">
                            ...
                            <div class="card-body p-lg-5">
                                <form method="POST" action="{{ route('register') }}" id="registration-form">
                                    ...
                                    @if(config('settings.captcha_registration'))
                                        {!! NoCaptcha::displaySubmit('registration-form', __('Register'), ['data-theme' => (request()->cookie('dark_mode') == 1 ? 'dark' : 'light'), 'data-size' => 'invisible', 'class' => 'btn btn-block btn-primary py-2']) !!}
                        ...
                        <div class="col-12 col-lg-7 bg-dark background-auth d-none d-lg-flex flex-fill bg-cover" style="background-image: url({{ asset('images/register.svg') }})">
