        ...
        <div class="container position-relative py-5 py-sm-6">
            ...
            <div class="row">
                ...
                <div class="col-12 py-sm-5">
                    ...
                    <h1 class="display-4 font-weight-bold text-center">{{ __('Hızlıca Link kısaltın') }}</h1>

                    <h2 class="text-muted font-weight-normal mt-4 font-size-xl text-center">{{ __('Boşluk kısmına istediğiniz bir linki girin ve link kısaltmasını gerçekleştirin.') }}</h2>
                                    ...
                                    <form action="{{ route('guest') }}" method="post" enctype="multipart/form-data" id="short-form">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-12 col-sm">
                                                ...
                                                <input type="text" dir="ltr" autocomplete="off" autocapitalize="none" spellcheck="false" name="url" class="form-control form-control-lg font-size-lg{{ $errors->has('url') || $errors->has('domain') || $errors->has('g-recaptcha-response') ? ' is-invalid' : '' }}" placeholder="{{ __('Hemen kısaltın') }}" autofocus>
                                            ...
                                            <div class="col-12 col-sm-auto">
                                                ...
                                                @if(config('settings.captcha_shorten'))
                                                    ...
                                                    {!! NoCaptcha::displaySubmit('short-form', __('Kısalt'), ['data-theme' => (request()->cookie('dark_mode') == 1 ? 'dark' : 'light'), 'data-size' => 'invisible', 'class' => 'btn btn-primary btn-lg btn-block font-size-lg mt-3 mt-sm-0']) !!}
                                                ...
                                                @else
                                                    ...
                                                    <button class="btn btn-primary btn-lg btn-block font-size-lg mt-3 mt-sm-0" type="submit">{{ __('Kısalt') }}</button>
    ...
    <div class="bg-base-1" id="features">
        ...
        <div class="container py-5 py-md-7">
            ...
            <div class="text-center">
                ...
                <h3 class="h2 mb-3 font-weight-bold text-center">{{ __('Özellikler') }}</h3>

                <div class="m-auto">

                    <p class="text-muted font-weight-normal font-size-lg">{{ __('Linklerinizi kısaltın ve hızlı bir şekilde trafik alın') }}</p>
                ...
                <div class="col-12 col-sm-6 col-md-4 pt-3 pr-md-3 pl-md-3 pt-lg-4 pr-lg-4 pl-lg-4 mt-4 feature">
                    ...
                    <div class="card border-0 shadow-sm h-100 border-lg">
                        ...
                        <div class="card-body d-flex flex-column rounded-lg p-4">
                            ...
                            <div class="d-block w-100 text-muted">{{ __('Giriş yapan ziyaretçilere daha hızlı bir link vermiş olun') }}</div>
                ...
                <div class="col-12 col-sm-6 col-md-4 pt-3 pr-md-3 pl-md-3 pt-lg-4 pr-lg-4 pl-lg-4 mt-4 feature">
                    ...
                    <div class="card border-0 shadow-sm h-100 border-lg">
                        ...
                        <div class="card-body d-flex flex-column rounded-lg p-4">
                            ...
                            <div class="d-block w-100"><h5 class="mt-1 mb-1 d-inline-block font-weight-bold">{{ __('Daha Kısa Görünüm') }}</h5></div>

                            <div class="d-block w-100 text-muted">{{ __('Sosyal medyalarda paylaşmak için daha kısa bir görünüme sahip olun') }}</div>
                ...
                <div class="col-12 col-sm-6 col-md-4 pt-3 pr-md-3 pl-md-3 pt-lg-4 pr-lg-4 pl-lg-4 mt-4 feature">
                    ...
                    <div class="card border-0 shadow-sm h-100 border-lg">
                        ...
                        <div class="card-body d-flex flex-column rounded-lg p-4">
                            ...
                            <div class="d-block w-100"><h5 class="mt-1 mb-1 d-inline-block font-weight-bold">{{ __('Hedeflere ulaşın') }}</h5></div>

                            <div class="d-block w-100 text-muted">{{ __('Tüm ülkelerden herhangi bir kısıt olmadan link paylaşımı yapın') }}</div>
        ...
        <!--<div class="bg-base-1">
            ...
            <div class="container position-relative text-center py-5 py-md-7 d-flex flex-column z-1">
                ...
                <div class="flex-grow-1">
                    ...
                    <div class="badge badge-pill badge-success mb-3 px-3 py-2">{{ __('Hemen Kısalt') }}</div>

                    <div class="text-center">

                        <h4 class="mb-3 font-weight-bold">{{ __('Link kısaltmaya Hazır mısınız?') }}</h4>

                        <div class="m-auto">

                            <p class="mb-5 font-weight-normal text-muted font-size-lg">{{ __('Ziyaretçilerinize daha kısa linkler gönderin.') }}</p>
