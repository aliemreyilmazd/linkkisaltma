@section('site_title', formatTitle([__('Legal'), config('settings.title')]))
...
<h2 class="mb-3 d-inline-block">{{ __('Legal') }}</h2>
...
<div class="card border-0 shadow-sm">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.legal') }}" method="post" enctype="multipart/form-data">
