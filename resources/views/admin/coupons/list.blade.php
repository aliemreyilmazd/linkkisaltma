...
<div class="d-flex">
    <div class="flex-grow-1">
        <h2 class="mb-3 d-inline-block">{{ __('Coupons') }}</h2>
    </div>
    <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            @if(request()->input('search') || request()->input('type') || request()->input('status') || request()->input('sort'))
                                                <a href="{{ route('admin.coupons') }}" class="text-secondary">{{ __('Reset') }}</a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col text-truncate">
                                <div class="row text-truncate">
                                    ...
                                    <div class="col-12 col-lg-2 text-truncate d-flex align-items-center">
                                        <span class="badge badge-{{ ($coupon->trashed() ? 'danger' : 'success') }}">{{ ($coupon->trashed() ? __('Disabled') : __('Active')) }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-auto">
