@section('site_title', formatTitle([__('Social'), config('settings.title')]))
...
<h2 class="mb-3 d-inline-block">{{ __('Sosyal') }}</h2>



<div class="card border-0 shadow-sm">

    <div class="card-header"><div class="font-weight-medium py-1">{{ __('Sosyal') }}</div></div>
    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.social') }}" method="post" enctype="multipart/form-data">
