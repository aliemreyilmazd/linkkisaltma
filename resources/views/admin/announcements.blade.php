@section('site_title', formatTitle([__('Duyurular'), config('settings.title')]))
...
<h2 class="mb-3 d-inline-block">{{ __('Duyurular') }}</h2>



<div class="card border-0 shadow-sm">

    <div class="card-header"><div class="font-weight-medium py-1">{{ __('Duyurular') }}</div></div>
    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.announcements') }}" method="post" enctype="multipart/form-data">
