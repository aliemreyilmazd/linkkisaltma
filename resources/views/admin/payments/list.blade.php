                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            @if(request()->input('search') || request()->input('type') || request()->input('status') || request()->input('sort'))
                                                <a href="{{ route('admin.payments') }}" class="text-secondary">{{ __('Reset') }}</a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center">
                                        ...
                                        <div class="text-truncate">
                                            <div class="d-flex align-items-center">
                                                ...
                                                @if(in_array($payment->status, ['completed', 'cancelled']))
                                                    <a href="{{ route('admin.invoices.show', $payment->id) }}" class="badge badge-secondary text-truncate" data-enable="tooltip" title="{{ __('Invoice') }}">{{ $payment->invoice_id }}</a>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-lg-5 d-flex align-items-center">
                                        @if(isset($payment->user))
                                            <div class="d-inline-block {{ (__('lang_dir') == 'rtl' ? 'ml-3' : 'mr-3') }} text-truncate">
                                                <img src="{{ gravatar($payment->user->email, 48) }}" class="rounded-circle width-6 height-6">
                                            </div>
