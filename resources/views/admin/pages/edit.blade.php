@section('site_title', formatTitle([__('Düzenle'), __('Sayfalar'), config('settings.title')]))



@include('shared.breadcrumbs', ['breadcrumbs' => [

    ['url' => route('admin.dashboard'), 'title' => __('Yönetici')],

    ['url' => route('admin.pages'), 'title' => __('Sayfalar')],
...
<h2 class="mb-3 d-inline-block">{{ __('Düzenle') }}</h2>
    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.pages.edit', $page->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <label for="i-content">{{ __('İçerik') }}</label>
            ...
            <button type="submit" name="submit" class="btn btn-primary">{{ __('Kaydet') }}</button>
