@section('site_title', formatTitle([__('Güncelle'), config('info.software.name')]))
...
<a href="{{ route('update.overview') }}" class="btn btn-block btn-primary d-inline-flex align-items-center mt-3 py-2">
    ...
    <span class="d-inline-flex align-items-center mx-auto">
        ...
        {{ __('Başla') }} @include((__('lang_dir') == 'rtl' ? 'icons.chevron-left' : 'icons.chevron-right'), ['class' => 'width-3 height-3 fill-current '.(__('lang_dir') == 'rtl' ? 'mr-2' : 'ml-2')])
