...
class LinkController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $links = Link::with('domain', 'space')
            ...
            ->appends(['search' => $search, 'domain' => $domain, 'space' => $space, 'pixel' => $pixel, 'by' => $by, 'sort' => $sort[2]]);

        return view('links.content', ['view' => 'list', 'links' => $links, 'spaces' => $spaces, 'domains' => $domains, 'pixels' => $pixels]);
    }
